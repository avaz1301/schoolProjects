...
public final class ParserAndTranslator {
    ...
    private static void whileStmt() throws SourceFileErrorException {
        ...
        expr7();
        accept(RPAREN);
        JUMPONFALSEinstr jonfalse = new JUMPONFALSEinstr(Instruction.OPERAND_NOT_YET_KNOWN);
        statement();
        new JUMPinstr(a);
        jonfalse.fixUpOperand(Instruction.getNextCodeAddress());
        //////////////////////////
        TJ.output.decTreeDepth();
    }
